"""Standalone API client for testing (no Home Assistant dependencies)."""
import logging
...
DEFAULT_BRAND_CODE = "AF"
DEFAULT_PRODUCT_CODE = "AG"

ENDPOINT_LOGIN = f"{BASE_URL}/login"
ENDPOINT_SUBSCRIPTIONS = f"{BASE_URL}/Subscription/listSubscriptions"
ENDPOINT_METERS = f"{BASE_URL}/leituras/getContadores"
ENDPOINT_CONSUMPTION = f"{BASE_URL}/History/consumo/carga"
